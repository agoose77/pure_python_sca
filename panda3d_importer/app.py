...
class PandaLogicImporter(SCALogicImporter):
    ...
    def build_keyboard(self, sensor_data):
        ...
        sensor.modifier_1 = sensor.get_panda_key_name(sensor_data['modifier_key_1'], left_right_unique=False)
        sensor.modifier_2 = sensor.get_panda_key_name(sensor_data['modifier_key_2'], left_right_unique=False)
